...
class InsertPaymentRequestUseCase {
  final ChatRepositoryImpl chatRepository;

  InsertPaymentRequestUseCase(this.chatRepository);

  Future<Either<ErrorState, void>> call({required PaymentModel payment}) async {
    return await chatRepository.insertPayment(payment);
  }
}
