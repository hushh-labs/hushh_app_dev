...
class FetchConversationUseCase {
  ...
  FetchConversationUseCase(this.chatRepository);

  Future<Either<ErrorState, Conversation?>> call({required String conversationId}) async {
    return await chatRepository.fetchConversation(conversationId);
  }
}
