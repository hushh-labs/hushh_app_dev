...
class InsertConversationUseCase {
  final ChatRepositoryImpl chatRepository;

  InsertConversationUseCase(this.chatRepository);

  Future<Either<ErrorState, void>> call({required Conversation conversation}) async {
    return await chatRepository.insertConversation(conversation);
  }
}
