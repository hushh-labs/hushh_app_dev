...
class _CreateLookbookPageState extends State<CreateLookbookPage>
            ...
            child: SlideTransition(
              ...
              child: Column(
                children: [
                  ...
                  // Products Grid
                  Expanded(
                    child: _buildProductsSection(state),
                  ),
                ],
              ),
            ),
  ...
  void _createLookbook() {
    ...
    print('📝 [CREATE_LOOKBOOK] Selected product IDs count: ${selectedProductIds.length}');
    ...
    print('📝 [CREATE_LOOKBOOK] Filtered selected products count: ${selectedProducts.length}');
    print('📝 [CREATE_LOOKBOOK] Total products in inventory: ${controller.inventoryAllProductsResult!.products.length}');
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                'Name: $lookbookName\nProducts: ${selectedProducts.length}\n\nAre you sure you want to create this lookbook?',
              ...
              Row(
                children: [
                  Expanded(
                    child: TextButton(
                      onPressed: () {
                        print('📝 [CREATE_LOOKBOOK] User cancelled creation');
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        print('📝 [CREATE_LOOKBOOK] User confirmed creation');
                        Navigator.pop(context);
                        // Set the selected products in the controller before creating
                        controller.selectedProducts = selectedProducts;
                        print('📝 [CREATE_LOOKBOOK] Set ${selectedProducts.length} products in controller');
                        print('📝 [CREATE_LOOKBOOK] Calling CreateLookbookEvent');
