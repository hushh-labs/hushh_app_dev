...
class UpdateHushhMeetInfoUseCase {
  final CardWalletPageRepositoryImpl cardWalletPageRepository;

  UpdateHushhMeetInfoUseCase(this.cardWalletPageRepository);

  Future<Either<ErrorState, void>> call(
      {required AgentMeeting meeting, String? uid}) async {
    return await cardWalletPageRepository.updateMeeting(meeting, uid);
  }
}
