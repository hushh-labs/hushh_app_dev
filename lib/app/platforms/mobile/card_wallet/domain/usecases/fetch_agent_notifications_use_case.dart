...
class FetchAgentNotificationsUseCase {
  final CardWalletPageRepositoryImpl cardWalletPageRepository;

  FetchAgentNotificationsUseCase(this.cardWalletPageRepository);

  Future<Either<ErrorState, List<CustomNotification>>> call(
      {required String uid}) async {
    return await cardWalletPageRepository.fetchAgentNotifications(uid);
  }
}
