...
class InsertHealthDataUseCase {
  ...
  InsertHealthDataUseCase(this.cardWalletPageRepository);

  Future<Either<ErrorState, void>> call(
      {required Map<HealthDataType, List<Map<String, dynamic>>> data}) async {
    return await cardWalletPageRepository.insertHealthData(data);
  }
}
