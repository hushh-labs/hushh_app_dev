...
class InsertMultipleAppUsagesUseCase {
  final SettingsPageRepositoryImpl settingsPageRepository;

  InsertMultipleAppUsagesUseCase(this.settingsPageRepository);

  Future<Either<ErrorState, void>> call(
      {required List<AppUsageData> appUsages}) async {
    return await settingsPageRepository.insertMultipleAppUsages(appUsages);
  }
}
