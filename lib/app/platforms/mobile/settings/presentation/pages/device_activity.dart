...
Future<dynamic> getUserAppUsageSummary() async {
  ...
  sl<SettingsPageBloc>().appUsage = response;
  return response;
}
...
class _DeviceActivityPageState extends State<DeviceActivityPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('My App Universe',
            ...
            children: [
              StreamBuilder(
                  ...
                  builder: (context, state) {
                    ...
                    return Padding(
                      padding: EdgeInsets.only(bottom: (appUsageInsights?.isNotEmpty ?? false) ? 16:0),
                      child: Column(
