...
class InsertUserInstalledCardUseCase {
  final CardMarketRepositoryImpl cardMarketRepository;

  InsertUserInstalledCardUseCase(this.cardMarketRepository);

  Future<Either<ErrorState, int>> call({required CardModel card}) async {
    return await cardMarketRepository.insertUserInstalledCard(card);
  }
}
