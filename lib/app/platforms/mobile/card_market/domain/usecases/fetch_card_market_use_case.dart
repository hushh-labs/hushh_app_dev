...
class FetchCardMarketUseCase {
  final CardMarketRepositoryImpl cardMarketRepository;

  FetchCardMarketUseCase(this.cardMarketRepository);

  Future<Either<ErrorState, List<CardModel>>> call() async {
    return await cardMarketRepository.fetchCardMarket();
  }
}
