...
import 'package:hushh_app/app/shared/core/hushh_story_editor/src/presentation/utils/constants/painting_type.dart';
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                  ...
                  ToolButton(
                    ...
                    child: Transform.scale(
                        ...
                        child: const ImageIcon(
                          AssetImage('assets/hushh_story_assets/icons/return.png'),
                          color: Colors.white,
                        )),
                  ),
                  ...
                  children: [
                    ToolButton(
                      ...
                      child: Transform.scale(
                          scale: 1.2,
                          child: ImageIcon(
                            const AssetImage('assets/hushh_story_assets/icons/pen.png'),
                    ...
                    ToolButton(
                      ...
                      child: Transform.scale(
                          scale: 1.2,
                          child: ImageIcon(
                            const AssetImage('assets/hushh_story_assets/icons/marker.png'),
                            color: paintingNotifier.paintingType ==
                                    PaintingType.marker
                                ? Colors.black
                                : Colors.white,
                    ...
                    ToolButton(
                      ...
                      child: Transform.scale(
                          scale: 1.2,
                          child: ImageIcon(
                            const AssetImage('assets/hushh_story_assets/icons/neon.png'),
                            color: paintingNotifier.paintingType ==
                                    PaintingType.neon
                                ? Colors.black
                                : Colors.white,
                ...
                //       scale: 0.7,
                //       child: const ImageIcon(
                //         AssetImage('assets/hushh_story_assets/icons/check.png'),
                //         color: Colors.white,
                //       )),
                // ),
              ],
