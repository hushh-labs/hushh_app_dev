import 'package:hushh_app/app/shared/core/components/custom_qr/shapes/shape.dart';
...
abstract class QrPixelShape extends QrElementShape {
  ...
  static QrPixelShapeCircle circle({double radiusFraction = 1}) =>
      QrPixelShapeCircle(radiusFraction: radiusFraction);

  static QrPixelShapeRoundCorners roundCorners({double cornerFraction = 1}) =>
...
class QrPixelShapeCircle extends QrPixelShape with ShapeCircle {
  ...
  const QrPixelShapeCircle({this.radiusFraction = 1.0});

  @override
  bool operator ==(Object other) =>
      other is QrPixelShapeCircle && other.radiusFraction == radiusFraction;
...
class QrPixelShapeRoundCorners extends QrPixelShape with ShapeRoundCorners {
  ...
  const QrPixelShapeRoundCorners({this.cornerFraction = .5});
