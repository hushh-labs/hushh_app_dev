# App Store Privacy & Consent Requirements
...
Guidelines that include ASR & NR apply to Notarization for iOS and iPadOS apps in the EU.
...
1.5ASR & NR Developer Information
...
2.5.6ASR & NR Apps that browse the web must use the appropriate WebKit framework and WebKit JavaScript. You may apply for an entitlement to use an alternative web browser engine in your app. Learn more about these entitlements.
...
4.7.2ASR & NR Your app may not extend or expose native platform APIs to the software without prior permission from Apple.
4.7.3ASR & NR Your app may not share data or privacy permissions to any individual software offered in your app without explicit user consent in each instance.
...
5.1.1ASR & NR Data Collection and Storage
...
5.1.2ASR & NR Data Use and Sharing
...
5.1.3ASR & NR Health and Health Research
...
5.5ASR & NR Mobile Device Management
...
5.6ASR & NR Developer Code of Conduct
...
5.6.2ASR & NR Developer Identity
