...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SecureBiometricSwift/SecureBiometricSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_media_metadata/flutter_media_metadata.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/local_auth_crypto/local_auth_crypto.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/razorpay_web/razorpay_web.framework"
